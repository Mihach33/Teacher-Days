...
public class SpawnPlayer : MonoBehaviour
{
    ...
    void Start()
    {
        if (PlayerPrefs.HasKey("x") && PlayerPrefs.HasKey("y") && PlayerPrefs.HasKey("z"))
        {
            ...
            rotation = new Quaternion(PlayerPrefs.GetFloat("rotationX", 0),
                PlayerPrefs.GetFloat("rotationY", 0), PlayerPrefs.GetFloat("rotationZ", 0),
                PlayerPrefs.GetFloat("rotationW", 0));
